...
df = pd.read_csv('essay_prompts_vicuna_33B.csv', sep=';')
...
for index, row in df.iterrows():
    ...
    prompt_template=f'''Your task is to write an essay (about 300-350 words) in response to a question. The topic will be provided by the user. USER: {prompt} ASSISTANT:
    ...
    df.to_csv('essay_prompts_vicuna_33B.csv', sep=';')
